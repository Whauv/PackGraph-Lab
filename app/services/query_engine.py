...
class QueryEngine:
    ...
    def ask(self, question: str, options: dict[str, Any] | None = None) -> dict[str, Any]:
        ...
        if intent == "refuse_or_clarify":
            if router == "private_data" and private_lookup["rows"]:
                return self._private_data_response(question, plan, private_lookup, classifier, retrieval)
    ...
    def _private_data_response(self, question: str, plan: dict[str, Any], private_lookup: dict[str, Any], classifier: dict[str, Any], retrieval: dict[str, Any]) -> dict[str, Any]:
    ...
    def _finalize_response(
        ...
        *,
        ...
        scored_rows = self._score_rows(normalized_rows)
